...
from model.state_variables import HubState
...
def get_active_validator_indices(state: HubState) -> Gwei:
    """
...
def get_awake_validator_indices(params: Parameters, state: HubState) -> Gwei:
    """
...
# Edited
def get_total_active_balance(params: Parameters, state: HubState) -> Gwei:
    """
    ...
    # State Variables
    polygn_staked = state["polygn_staked"]
    ...
    total_active_balance = polygn_staked * constants.gwei
    ...
    return Gwei(total_active_balance)
...
def get_base_reward_per_increment(params: Parameters, state: HubState) -> Gwei:
...
def get_base_reward(params: Parameters, state: HubState) -> Gwei:
...
def get_proposer_reward(params: Parameters, state: HubState) -> Gwei:
...
def get_validator_churn_limit(params: Parameters, state: HubState) -> int:
    """
