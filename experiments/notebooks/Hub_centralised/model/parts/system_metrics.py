...
def policy_validator_costs(
    ...
    validator_hardware_costs_per_month = params["validator_hardware_costs_per_month"]
...
def policy_validator_yields(
    ...
    total_priority_fee_to_validators_usd = previous_state["total_priority_fee_to_validators_usd"]
    ...
    total_priority_fee_to_validators_yields = total_priority_fee_to_validators_usd / (polygn_staked * polygn_price)* constants.epochs_per_year / dt
    ...
    return {
        ...
        "total_priority_fee_to_validators_yields": total_priority_fee_to_validators_yields,
